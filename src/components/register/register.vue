  ...
  export default {
    ...
    methods:{
      ...
      _register(){
        ...
        var data;
        // 会员账号正则
        var reg=/^[a-zA-Z][a-zA-Z0-9_]{5,8}$/;
        // 会员密码正则
        var pass=/(?![^a-zA-Z0-9]+$)(?![^a-zA-Z/D]+$)(?![^0-9/D]+$).{6,20}$/;
        // 姓名验证
        var regNmae = /^[\u4E00-\u9FA5A-Za-z]+$/;
        // 号码验证
        var regPhone = /^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/;
        var hrefID = window.location.href;
        // var urlId;
        var urlId = hrefID.substring(hrefID.indexOf("register")+9,hrefID.length);
