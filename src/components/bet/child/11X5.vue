		...
		<div class="clockView">
			<div class="left" style="position: relative;">
				...
				<p style="display: flex;align-items: center;text-align: center;justify-content: center;">
					<img src="../../../../static/img/lingdang.png" style="width: 0.3rem;margin-right:0.1rem;" /> 第{{kindId!='azssc'?showPrevAwarPeriod:prevAwarPeriod2}}期
				</p>
				<ul>
			...
			<div class="right">
				<p style="display: flex;align-items: center;text-align: center;justify-content: center;"><img src="../../../../static/img/naozhong.png" style="width: 0.3rem;margin-right:0.1rem;" />第{{kindId!='azssc'?showCurrentAwarPeriod:currentAwarPeriod2}}期</p>
						...
						<div class="tab-item" v-for="(item,index) in winList" v-if="item.awardNum!=null">
							...
							<div class="right">
								...
								<div class="nums-wrap" v-if="tableType==2">
									<span :class="item.awardNum.split(',')[0]>=6?'num-round orange':'num-round blue'">{{item.awardNum.split(',')[0]>=5?'大':'小'}}</span>
									<span :class="item.awardNum.split(',')[1]>=6?'num-round orange':'num-round blue'">{{item.awardNum.split(',')[1]>=5?'大':'小'}}</span>
									<span :class="item.awardNum.split(',')[2]>=6?'num-round orange':'num-round blue'">{{item.awardNum.split(',')[2]>=5?'大':'小'}}</span>
									<span :class="item.awardNum.split(',')[3]>=6?'num-round orange':'num-round blue'">{{item.awardNum.split(',')[3]>=5?'大':'小'}}</span>
									<span :class="item.awardNum.split(',')[4]>=6?'num-round orange':'num-round blue'">{{item.awardNum.split(',')[4]>=5?'大':'小'}}</span>
								</div>
