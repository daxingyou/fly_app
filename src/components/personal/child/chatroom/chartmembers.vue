                ...
                <yd-list theme="1" slot="list">
                  <yd-list-item v-for="(item,index) in friendsList" :key="index">
                    <yd-list-other slot="other">
                      <MessageBox @click.native="$router.push({name:'memberCenter',query:{account:item.friendAccount}})" :name="item.nickName||'1'">
                        <div v-if="!item.accountProperties||item.accountProperties==='1'" id="_img" slot="img" :class="'sprite-icon-'+item.icon" alt=""></div>
