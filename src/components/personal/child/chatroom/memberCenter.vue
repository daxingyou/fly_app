<template>
    <div id="memberCenter">
         <yd-navbar :title="$route.query.account!==userDetails.account?'个人资料':'我的资料'">      
            ...
            <i v-show="$route.query.account!==userDetails.account&&show3"  @click="more" name="more" slot="right" class="fa fa-navicon" style="font-size:.4rem;color:#fff;"></i>       
        </yd-navbar>
        <div class="container">
            <div class="personal">
                <div v-if="!UserByAccount.accountProperties||UserByAccount.accountProperties==='1'" :class="'sprite-icon-'+UserByAccount.icon" alt=""></div>
            ...
            <yd-cell-item  href="#" type="link">
              ...
              <yd-cell-item  href="#" type="link">
                <!-- <yd-icon name="footmark" slot="icon"  size=".42rem"></yd-icon>  Example of check -->
...
<!--查询好友列表时的成员资料的底部弹框 （删除好友  设置备注功能）-->
         <yd-popup v-model="show" position="bottom" height="3rem">
           <Box @click.native="deleteFriend(account)" height="1rem" backgroundColor="#fff" colorEffect="#d3d3d3">
             <p>
               ...
               <i class="fa fa-trash-o" style="font-size:.4rem;color:#525252;"></i>  
            ...
            <Box @click.native="$router.push({path:'/friendGroups',query:{friendAccount:account}})"  height="1rem" backgroundColor="#fff" colorEffect="#d3d3d3">
             <p>
               <!-- <yd-icon name="feedback" size=".4rem" color="#525252"></yd-icon>  -->
               <i class="fa fa-pencil-square-o" style="font-size:.4rem;color:#525252;"></i> 
          ...
          <Box v-if="isPower" @click.native="moveOut"  height="1rem" backgroundColor="#fff" colorEffect="#d3d3d3">
            ...
            <Box v-else height="1rem" backgroundColor="#d3d3d3" colorEffect="#d3d3d3">
             <p>
               ...
               <i class="fa fa-user-circle" style="font-size:.4rem;color:#fff;"></i>  
...
<!-- 加好友时的备注弹框 -->
         <yd-popup v-model="show4" position="center" width="90%" :close-on-masker="false">
            <div style="background-color:#fff;padding:.2rem .3rem">
               <p style="margin-bottom:.2rem;display:flex;justify-content:space-between">备注：<span style="display:flex;align-items:center">{{remark.length}}/20</span></p>
               <div>
  ...
  watch: {
    ...
    remark(newValue, oldValue) {
      if (newValue.length > 20) {
        this.remark = this.remark.slice(0, 20);
      }
    }
  },
