    ...
    <div class="container">
      ...
      <yd-cell-group>
        <yd-cell-item>
          ...
          <i  slot="icon" class="fa fa-star" style="font-size:.15rem;color:#fff;"></i>
        ...
        <yd-cell-item>
          ...
          <i slot="icon" class="fa fa-star" style="font-size:.15rem;color:#d7000b;"></i>
  ...
  computed: {
    ...
    bankList() {
      ...
      if (typeof this.drawCondition.bankList === "object") {
        for (var item of this.drawCondition.bankList) {
          arr.push({
