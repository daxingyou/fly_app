	...
	actions: {
		nowAllKindMessage(){
			return new Promise((resolve, reject) => {
				var res = request('get', 'nowAllKindMessage').then((res) => {
					resolve(res)
				})
			})
		},
		querySlidesImg(){
			return new Promise((resolve, reject) => {
				var res = request('get', 'querySlidesImg').then((res) => {
					resolve(res)
				})
			})
		},
		signOut() {
			return new Promise((resolve, reject) => {
				var res = request('get', 'signOut').then((res) => {
					resolve(res)
				})
			})
		},
		...
		queryNoticeAlertList({
			...
			return new Promise((resolve, reject) => {
				var res = request('get', 'queryNoticeAlertList', params).then((res) => {
		...
		queryLotteryOrderOwn({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'queryLotteryOrderOwn', params).then((res) => {
		...
		kind({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'kind').then((res) => {
					commit('savekind', res)
					resolve(res)
				})
			})
		...
		kindSum({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'kindSum').then((res) => {
		...
		queryMemberReportOne({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'queryMemberReportOne', params).then((res) => {
		...
		cancelOrder({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'cancelOrder', params).then((res) => {
		...
		winHistory({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'winHistory', params).then((res) => {
		...
		winsDragon({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'winsDragon', patams).then((res) => {
		...
		openRecord({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'openRecord', patams).then((res) => {
		...
		memberIfBind({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'memberIfBind').then((res) => {
		...
		saveMemberOtherBank({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'saveMemberOtherBank', params).then((res) => {
		...
		saveMemberBank({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'saveMemberBank', params).then((res) => {
		...
		queryMemberNoticeList({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'queryMemberNoticeList', params).then((res) => {
		...
		feedback({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'feedback', params).then((res) => {
		...
		helpService({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'helpService').then((res) => {
					resolve(res)
				})
			})
		},
		...
		updateNoticeAlert({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'updateNoticeAlert', params).then((res) => {
		...
		deleteNoticeAlert({
			...
			return new Promise(function(resolve, reject) {
				var res = request('get', 'deleteNoticeAlert', params).then((res) => {
		...
		myOrderList({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'myOrderList', params).then(res => {
		...
		balance({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'balance', params).then(res => {
		...
		amountOut({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'amountOut', params).then(res => {
		...
		withdrawal({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'withdrawal', params).then(res => {
		...
		open({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'open', params).then(res => {
		...
		register({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'register', params).then(res => {
		...
		moneySwitch({
			...
			return new Promise(function(resolve, reject) {
				var res = request('post', 'moneySwitch', params).then(res => {
		...
		playformAll({
			...
			return new Promise((resolve, reject) => {
				var res = request('get', 'playformAll').then((res) => {
					resolve(res)
				})
			})
		},
