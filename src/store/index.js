...
const getters = {
  ...
  datas(state) {
    return function (routerId) {
      var arr = [];
      var datasmap = [...state.dataList, ...state.dataList2];
      for (var item of datasmap) {
        if (routerId === 'bank') {
  ...
  incomeMessage(state) {
    return function (routerId) {
      //公司入款的路由数组
      var routers = ["bank", "qqTransfer", "alipayTransfer", "wechatTransfer", ];
      for (var item of state.income) {
        if (item.id === '0') {
  ...
  memberModel_p(state) {
    var arr = Array.of()
    for (var i = 0; i < state.memberModel.length; i += 10) {
  ...
  activeNum(state) {
    var num = 0;
    for (var item of state.activities) {
...
const actions = {
  ...
  saveDiy({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'saveDiy', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  queryBank({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'queryBank', params).then((res) => {
        if (res.code === 2) {
          if (params.type === '0') {
  ...
  queryIncome({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('get', 'queryIncome').then((res) => {
        if (res.code === 0) {
  ...
  saveMoneyOrder({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'saveMoneyOrder', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  updateMoneyOrder({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'updateMoneyOrder', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  saveThreeOrder({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'saveThreeOrder', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  updateThreeOrder({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'updateThreeOrder', params).then((res) => {
  ...
  queryDrawCondition({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('get', 'queryDrawCondition').then((res) => {
        if (res.code === 0) {
  ...
  saveDrawMoneyInfo({
    ...
    return new Promise(function (resolve, reject) {
      var res = request('post', 'saveDrawMoneyInfo', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  websocketLink({
    ...
    return new Promise(function (resolve, reject) {
      var accord = window.location.protocol;
      var str, socket, url;
      if (accord == "https:") {
        str = "wss:";
        ...
        str = "ws:";
        // url = this.global.baseUrl.slice(5);
        url = "//fly.pxklos.com";
      }
      var user = state.login.userDetails.account;
      socket = new WebSocket(
        encodeURI(str + url + "/websocket/" + user + '/3')
      );
      resolve(socket);
    })
  },
  queryMemberModel({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'queryMemberModel', params).then((res) => {
  ...
  updateMemberModel({
    ...
    return new Promise((resolve, reject) => {
      var res = request('post', 'updateMemberModel', params).then((res) => {
        resolve(res)
      })
    })
  },
  signTime({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'signTime').then((res) => {
        resolve(res)
      })
    })
  },
  signRecord({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'signRecord').then((res) => {
        resolve(res)
      })
    })
  },
  queryActivity({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'queryActivity').then((res) => {
  ...
  getBetAwardAmount({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'getBetAwardAmount').then((res) => {
        resolve(res)
      })
    })
  },
  queryOrderByNo({
    ...
    return new Promise((resolve, reject) => {
      var res = request('post', 'queryOrderByNo', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  activityAward({
    ...
    return new Promise((resolve, reject) => {
      var res = request('post', 'activityAward', params).then((res) => {
        resolve(res)
      })
    })
  },
  ...
  redPacket({
    ...
    return new Promise((resolve, reject) => {
      var res = request('get', 'redPacket').then((res) => {
        resolve(res)
      })
    })
  },
