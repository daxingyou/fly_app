  ...
  actions: {
    ...
    queryChildBill({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryChildBill', params).then((res) => {
    ...
    queryMemberReport({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryMemberReport', params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    queryMemberReportAll({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryMemberReportAll', params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    myCash({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('get', 'myCash', params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    queryLotteryReport({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryLotteryReport', params).then((res) => {
          if (res.code === 0) {
    ...
    queryLoginInfo({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryLoginInfo', params).then((res) => {
    ...
    updateLoginPassword({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'updateLoginPassword', params).then((res) => {
    ...
    updateTradePassword({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'updateTradePassword', params).then((res) => {
    ...
    saveSafeQuestion({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'saveSafeQuestion', params).then((res) => {
    ...
    queryAgentMemberInfo({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryAgentMemberInfo', params).then((res) => {
    ...
    queryMemberInfoEdit({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('get', 'queryMemberInfoEdit', params).then((res) => {
    ...
    queryTeamQutaType({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'queryTeamQutaType', params).then((res) => {
    ...
    updateTeamRebet({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'updateTeamRebet', params).then((res) => {
    ...
    updateMemberAgent({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'updateMemberAgent', params).then((res) => {
    ...
    agentRegisterMember({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'agentRegisterMember', params).then((res) => {
    ...
    queryPromoteUrl({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('get', 'queryPromoteUrl', params).then((res) => {
    ...
    updateOwnInfo({
      ...
      return new Promise(function (resolve, reject) {
        ...
        var res = request('post', 'updateOwnInfo', params).then((res) => {
    ...
    savePromoteUrl({
      ...
      return new Promise(function (resolve, reject) {
        var res = request('post', 'savePromoteUrl', params).then((res) => {
	...
	queryRedPacket({
		...
		return new Promise((resolve, reject) => {
		  var res = request('post', 'queryRedPacket', params).then((res) => {
			resolve(res)
		  })
		})
	  },
